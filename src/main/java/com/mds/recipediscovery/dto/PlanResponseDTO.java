...
public class PlanResponseDTO {
    ...
    private boolean isAiProcessing;
    private Set<PlanDetailResponseDTO> details;
    public PlanResponseDTO(Integer planId, String name, LocalDate startDate, LocalDate endDate, boolean isActive, boolean isAiProcessing) {
        this.planId = planId;
        this.name = name;
